...
const testimonials = [
  {
    ...
    role: "Loyal Customer",
    content:
      "Amazing and exceptional service from Mark Opticals always! I have been ordering spectacles and contact lenses from them for over 15 years now. They always have the latest styles and frames.",
    rating: 5,
  },
  {
    name: "Sagar Shah",
    role: "Customer",
    content:
      "Very quick service. It was an absolute delight to see the new year with my new glasses. Mr. Ansh is a very kind and friendly gentleman. His guidance has been very helpful.",
    rating: 4,
  },
  {
    ...
    role: "Customer",
    content:
      "Extremely happy with Mark Optical Co. I am an old customer; past 8 years I am purchasing Glasses/Sunglasses almost for my whole family members from this place. They are like family.",
    rating: 5,
  },
];
